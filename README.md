...
[![Tests](https://img.shields.io/badge/tests-1854%20passing-brightgreen)](https://github.com/01laky/ReVitae/releases)
...
Full pre-commit runs all **1854+** tests including the 51-variant matrix. For intermediate
commits:
