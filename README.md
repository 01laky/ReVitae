...
[![Tests](https://img.shields.io/badge/tests-2104%20passing-brightgreen)](https://github.com/01laky/ReVitae/releases)
...
Full pre-commit runs all **2104+** tests including the 51-variant matrix. For intermediate
commits:
