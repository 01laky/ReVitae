...
public static class WorkExperienceSorter
{
	public static IReadOnlyList<WorkExperienceEntry> SortByDateNewestFirst(IReadOnlyList<WorkExperienceEntry> entries)
	{
	...
	private static SortScore BuildSortScore(WorkExperienceEntry entry, int originalIndex)
	{
	...
	private sealed record IndexedEntry(WorkExperienceEntry Entry, int Index);
